    ...
    for row in board:
        for col in row:
            if col in ['r','R']:
                ...
                bCount+=1
    print("Red on board",rCount,"    Black on board",bCount)
    if rCount==0:
        return [True,"black"]
    if bCount==0:
        return [True,"red"]
...
def checkers():
    ...
    if currentPlayer=="red":
        move=P2.getValidPlayerAction(currentPlayer,currentPlayerTokens,opposingPlayerTokens,board,forwardRowInc)
    else:
        move=P1.getValidPlayerAction(currentPlayer,currentPlayerTokens,opposingPlayerTokens,board,forwardRowInc)        
