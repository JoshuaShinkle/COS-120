...
#Heuristic 5 NOT COMPLETE - uses my information and the potential jumps of the opponent to pick a blocking jump
def blockOpponentJumpWithJump(expandedJumpsList,opponentExpandedJumpsList):
    blockingJumps=[]
    return blockingJumps

#Heuristic 6 NOT COMPLETE - uses potential jumps by opponent and looks for blocking moves
